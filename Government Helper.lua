...
function imgui.OnDrawFrame()
	if window.v then
		...
		if menu == 1 then
			...
			GHsms('Бинд {ADFF2F}«'..cfg.Binds_Name[key_bind]..'»{FFFFFF} удалён!')
		...
		imgui.Begin(u8'##menu2', _, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.AlwaysAutoResize)
			...
			imgui.BeginChild('##menu2Child', imgui.ImVec2(505, 85), true)
				if imgui.Button(u8'Выгнать##menu2', imgui.ImVec2(160,20)) then
					sampProcessChatInput('/expel '..tonumber(IDplayer.v)..' Н.П.М.')
				end
				imgui.SameLine()
...
function checklibs()
	...
	if not sampevcheck then
		...
		DownloadFile('https://github.com/THE-FYP/SAMP.Lua/raw/master/samp/events.lua', getWorkingDirectory().."/lib/samp/events.lua");GHsms('Загружено 1/8')
		DownloadFile('https://github.com/THE-FYP/SAMP.Lua/raw/master/samp/raknet.lua', getWorkingDirectory().."/lib/samp/raknet.lua");GHsms('Загружено 2/8')
		DownloadFile('https://github.com/THE-FYP/SAMP.Lua/raw/master/samp/synchronization.lua', getWorkingDirectory().."/lib/samp/synchronization.lua");GHsms('Загружено 3/8')
		DownloadFile('https://github.com/THE-FYP/SAMP.Lua/raw/master/samp/events/bitstream_io.lua', getWorkingDirectory().."/lib/samp/events/bitstream_io.lua");GHsms('Загружено 4/8')
		DownloadFile('https://github.com/THE-FYP/SAMP.Lua/raw/master/samp/events/core.lua', getWorkingDirectory().."/lib/samp/events/core.lua");GHsms('Загружено 5/8')
		DownloadFile('https://github.com/THE-FYP/SAMP.Lua/raw/master/samp/events/extra_types.lua', getWorkingDirectory().."/lib/samp/events/extra_types.lua");GHsms('Загружено 6/8')
		DownloadFile('https://github.com/THE-FYP/SAMP.Lua/raw/master/samp/events/handlers.lua', getWorkingDirectory().."/lib/samp/events/handlers.lua");GHsms('Загружено 7/8')
		DownloadFile('https://github.com/THE-FYP/SAMP.Lua/raw/master/samp/events/utils.lua', getWorkingDirectory().."/lib/samp/events/utils.lua");GHsms('Загружено 8/8')
